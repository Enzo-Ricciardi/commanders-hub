import { GameData, Commander, Ship, StarSystem, StoredShip, Material, Mission, ExplorationScan, Resource, FleetCarrier } from '../types';

export const mockCommander: Commander = {
  name: "CMDR Maverick",
  credits: 145890234,
...
export const mockSystem: StarSystem = {
    name: "Sol",
...
export const mockStoredShips: StoredShip[] = [
...
export const mockExplorationScans: ExplorationScan[] = [
    {
        id: 'scan1',
...
export const mockFleetCarrier: FleetCarrier = {
...
export const fetchGameData = (): Promise<GameData> => {
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      resolve({
        ...
        ship: mockShip,
        system: mockSystem,
        storedShips: mockStoredShips,
        materials: mockMaterials,
        missions: mockMissions,
        explorationScans: mockExplorationScans,
        fleetCarrier: mockFleetCarrier,
      });
